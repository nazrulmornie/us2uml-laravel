		...
		<div class="row">
			<div class="col-lg-6 mb-4 mb-lg-0">
				<div class="video-player">
					<img class="img-fluid rounded w-100" src="{{ asset('theme/images/slider/video-player-thumb.jpg') }}" alt="">
...
<section class="about section-sm" id="about">
	<div class="container">
		<div class="row mb-5 justify-content-center">
			<div class="col-md-5">
				<img src="{{ asset('theme/images/about/about-1.jpg') }}" class="img-fluid rounded shadow w-100" alt="about-img">
			</div>
			<div class="col-md-5">
				<div class="content">
		...
		<div class="row justify-content-center">
			...
			<div class="col-md-5 order-md-2 order-1">
				<img src="{{ asset('theme/images/about/about-2.jpg') }}" class="img-fluid rounded shadow w-100" alt="">
			</div>
		</div> <!-- End row -->
	</div> <!-- End container -->
</section> <!-- End section -->
		...
		<div class="row filtr-container">
			<div class="col-md-4 col-sm-6 p-0 filtr-item" data-category="design">
				<div class="portfolio-block">
					<img class="img-fluid" src="{{ asset('theme/images/portfolio/portfolio-1.jpg') }}" alt="">
					<div class="caption">
						<a class="search-icon" href="{{ asset('theme/images/portfolio/portfolio-1.jpg') }}" data-lightbox="image-1">
			...
			<div class="col-md-4 col-sm-6 p-0 filtr-item" data-category="design, ios">
				<div class="portfolio-block ">
					<img class="img-fluid" src="{{ asset('theme/images/portfolio/portfolio-2.jpg') }}" alt="">
					<div class="caption">
						<a class="search-icon" href="{{ asset('theme/images/portfolio/portfolio-1.jpg') }}" data-lightbox="image-1">
							<i class="tf-ion-ios-search-strong"></i>
						</a>
			...
			<div class="col-md-4 col-sm-6 p-0 filtr-item" data-category="photography, development">
				<div class="portfolio-block">
					<img class="img-fluid" src="{{ asset('theme/images/portfolio/portfolio-3.jpg') }}" alt="">
					<div class="caption">
						<a class="search-icon" href="{{ asset('theme/images/portfolio/portfolio-1.jpg') }}" data-lightbox="image-1">
							<i class="tf-ion-ios-search-strong"></i>
						</a>
			...
			<div class="col-md-4 col-sm-6 p-0 filtr-item" data-category="photography, ios">
				<div class="portfolio-block">
					<img class="img-fluid" src="{{ asset('theme/images/portfolio/portfolio-4.jpg') }}" alt="">
					<div class="caption">
						<a class="search-icon" href="{{ asset('theme/images/portfolio/portfolio-1.jpg') }}" data-lightbox="image-1">
							<i class="tf-ion-ios-search-strong"></i>
						</a>
			...
			<div class="col-md-4 col-sm-6 p-0 filtr-item" data-category="design">
				<div class="portfolio-block">
					<img class="img-fluid" src="{{ asset('theme/images/portfolio/portfolio-5.jpg') }}" alt="">
					<div class="caption">
						<a class="search-icon" href="{{ asset('theme/images/portfolio/portfolio-1.jpg') }}" data-lightbox="image-1">
							<i class="tf-ion-ios-search-strong"></i>
						</a>
		...
		<div class="row">
			...
			<div class="col-lg-3 col-sm-6">
				<div class="team-member text-center">
					<div class="member-photo">
						<!-- member photo -->
						<img class="img-fluid" src="{{ asset('theme/images/team/member-1.jpg') }}" alt="team people">
						<!-- /member photo -->
					</div>
			...
			<div class="col-lg-3 col-sm-6">
				<div class="team-member text-center">
					<div class="member-photo">
						<!-- member photo -->
						<img class="img-fluid" src="{{ asset('theme/images/team/member-2.jpg') }}" alt="team people">
						<!-- /member photo -->
					</div>
					<!-- member name & designation -->
					<div class="member-content">
			...
			<div class="col-lg-3 col-sm-6">
				<div class="team-member text-center">
					<div class="member-photo">
						<!-- member photo -->
						<img class="img-fluid" src="{{ asset('theme/images/team/member-3.jpg') }}" alt="team people">
						<!-- /member photo -->
			...
			<div class="col-lg-3 col-sm-6">
				<div class="team-member text-center">
					<div class="member-photo">
						<!-- member photo -->
						<img class="img-fluid" src="{{ asset('theme/images/team/member-4.jpg') }}" alt="team people">
						<!-- /member photo -->
					</div>
				...
				<div class="testimonial-slider">
					...
					<div class="item text-center">
						...
						<div class="client-thumb">
							<img src="{{ asset('theme/images/client-logo/clients-1.jpg') }}" class="img-fluid" alt="">
						</div>
					...
					<div class="item text-center">
						...
						<!-- client photo -->
						<div class="client-thumb">
							<img src="{{ asset('theme/images/client-logo/clients-2.jpg') }}" class="img-fluid" alt="">
						</div>
						<div class="client-meta">
							<h4>Elon Musk</h4>
							<span>CEO , Company Name</span>
		...
		<div class="row justify-content-center">
			...
			<article class="col-md-4 col-sm-6" >
				<div class="post-item">
					<div class="post-thumb">
					  	<img class="img-fluid shadow rounded" src="{{ asset('theme/images/blog/post-1.jpg') }}" alt="Generic placeholder image">
					</div>
			...
			<!-- single blog post -->
				<article class="col-md-4 col-sm-6" >
					<div class="post-item">
						<div class="post-thumb">
						  	<img class="img-fluid shadow rounded" src="{{ asset('theme/images/blog/post-2.jpg') }}" alt="Generic placeholder image">
						</div>
				  		<div class="post-title">
			...
			<!-- single blog post -->
				<article class="col-md-4 col-sm-6" >
					<div class="post-item">
						<div class="post-thumb">
						  	<img class="img-fluid shadow rounded" src="{{ asset('theme/images/blog/post-3.jpg') }}" alt="Generic placeholder image">
						</div>
				  		<div class="post-title">
