...
<div class="container py-5 px-2">
    <div class="centerItems">
        <h1 class ="text-center text-black-50 mb-5">Welcome to US2UML site</h1>
    </div>
    <h5>This site is developed to collect user stories from students and professionals as part of a research named
        Visualisation of User Stories to UML and Goal Model. More information of this project can be obtained below.
    </h5>
    ...
    <div class="container-fluid py-5">
        <div class="container pt-5 pb-3">
            ...
            <div class="row">
                <h3>The research questions mentioned earlier can be answered through a set of objectives.
